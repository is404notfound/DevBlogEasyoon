          ...
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded-xl bg-gray-50 pt-5 shadow-md dark:bg-gray-900/70 dark:shadow-gray-800/40 sm:flex">
            <div className="px-6 py-4">
              {pathname.startsWith('/blog') ? (
                <h3 className="font-bold uppercase text-primary-500">{t('Tags')}</h3>
              ) : (
                <Link
                  href={`/blog`}
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        ...
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="dark:bg-gray-400 rounded px-3 py-2 text-sm font-medium uppercase text-gray-500 hover:bg-primary-400 dark:text-gray-800 dark:hover:text-gray-600"
