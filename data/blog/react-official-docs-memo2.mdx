...
this.state = {filterText: '', inStockOnly: false} 를 FilterableProductTable의 constructor에 추가하여 애플리케이션의 초기 상태를 반영 후, filterText와 inStockOnly를 ProductTable와 SearchBar에 prop으로 전달하는 식.
